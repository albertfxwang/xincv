...
\usepackage{geometry}
\newcommand{\marg}{0.83in}
\geometry{letterpaper,tmargin=\marg,bmargin=\marg,lmargin=1in,rmargin=1in,headheight=0in,headsep=.27in,footskip=.4in}
...
\setlength{\parskip}{0.6ex plus 0.4ex minus 0.2ex}      % fontsize = 10
...
%    \textsc{Date and Place of Birth:}       & September 1$^{\rm st}$, 1988  |  Tianjin, China \\
    ...
    \textsc{Email, Phone, Web:}  & \href{mailto:xwang@astro.ucla.edu}{xwang@astro.ucla.edu}  |  +1-805-574-0025  |  \url{http://www.astro.ucla.edu/~xwang}\\
...
\begin{list}{\labelitemi}{\leftmargin=1.8em}
...
\textsc{2015--2017}  & Volunteer in the annual \textsc{Exploring Your Universe!} events, University of California, Los Angeles  \\
...
%--------------------------------------------------------
  ...
  & \textbf{Project in progress and scientific product:
        \hyperlink{18.wang.apj}{Wang et al. (2018)},        =>      \hypertarget{18.wang.apj}{} \textbf{Wang, X.}
...
%--------------------------------------------------------
  ...
  %The best-fits from our most generalized constraint read $\Sigma m_{\nu}=0.556^{+0.231}_{-0.288}\rm eV$,
  %$N_{\rm eff}=3.839\pm0.452$, and $w=-1.058\pm0.088$.
