...
\usepackage{geometry}
\geometry{letterpaper,tmargin=1in,bmargin=1in,lmargin=1in,rmargin=1in,headheight=0in,headsep=0in,footskip=0in}
...
%    \textsc{Mailing Address:} & 3251 S. Sepulveda Blvd., Apt. 307, Los Angeles, CA 90034, the USA \\
%\end{tabular}
...
%\begin{tabular}{r|p{17.5cm}}
  ...
  \textsc{Present}
  & Field of Interest: Chemical Evolution of Galaxies, Nebular Emission Spectroscopy, Strong Gravitational Lensing. \\
  ...
  & \texttt{Advisors: Profs. Gong-Bo Zhao, Charling Tao, Tong-Jie Zhang, Y. F. Huang}   \\
  \multicolumn{2}{c}{} \\
  %--------------------------------------------------------
...
%\begin{longtable}{r|p{17cm}}
  ...
  & \textbf{Project in progress and scientific products: 
        \hyperlink{16.wang.apj}{Wang et al. (2016)},
...
%      \textit{Astrophys. J. Letters}, 782L, 36, (\href{http://arxiv.org/abs/1401.0532}{arXiv:1401.0532})
    ...
    \item[5]\hypertarget{16.wang.apj}{} \textbf{Wang, X.} et al. The Grism Lens-Amplified Survey from Space (GLASS) X.
        Sub-kpc resolution gas-phase metallicity maps at cosmic noon behind the Hubble Frontier Fields cluster MACS1149.6+2223. 
        2016, submitted to ApJ (\href{http://arxiv.org/abs/1610.07558}{arXiv:1610.07558})
\end{list}  \\
