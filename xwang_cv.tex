...
\begin{tabular}{r|p{17.5cm}}
  ...
  \textsc{Present}
  & Field of Interest: Strong Gravitational Lensing, Galaxy Clusters, Cosmology.     \\
...
\begin{list}{\labelitemi}{\leftmargin=0.5em}
  ...
  Mass Fraction Using the Cosmic Distance-Duality Relation and Type Ia Supernovae. 2013, RAA, 13, 1013 (\href{http://arxiv.org/abs/1305.2077}{arXiv:1305.2077})
    ...
    \item[7]\hypertarget{15.wang.apj}{} \textbf{Wang, X.}, Hoag, A., Huang, K., Treu, T., Bradac, M., Schmidt, K. B. et al. The
      Grism Lens-Amplified Survey from Space (GLASS). IV. Mass reconstruction of the lensing cluster Abell 2744 from frontier
      field imaging and GLASS spectroscopy. 2015, \textit{Astrophys. J.}, submitted
      (\href{http://arxiv.org/abs/1504.02405}{arXiv:1504.02405}) 
\end{list}  \\
